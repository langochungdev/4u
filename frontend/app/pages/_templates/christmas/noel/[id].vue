...
<template>
  <ClientOnly>
    <div ref="rootRef" class="noel-love-root">
      ...
      <div v-show="showScene" class="container">
  ...
  <g class="whole">
    ...
    <g class="treeStar">
      ...
      <path d="M408.12,83.45l-17.78,8.94,3.72-19.55-14-14.15,19.74-2.5,9.13-17.68,8.48,18L437,59.73l-14.5,13.63,3,19.67Z" fill="red" />
    </g>
