<template>
  <div class="main-bg relative w-full h-screen overflow-hidden font-sans">
    <div
      class="absolute inset-0 z-0 opacity-30 bg-notebook-pattern pointer-events-none"
    ></div>
    ...
    <Transition name="fade">
      ...
      >
        <img
          :src="flowerGif"
          alt="Bó hoa"
          class="w-48 h-48 animate-bounce drop-shadow-xl"
        />
    ...
    <Transition name="zoom">
      ...
      >
        <div
          class="w-full max-w-sm p-5 shadow-2xl rounded-2xl border border-white/50"
          style="
        ...
        >
          <h1
            class="text-center text-lg font-bold text-pink-600 mb-3 drop-shadow-sm"
          >
            {{ headerText }}
          </h1>

          <div
            class="relative w-full overflow-hidden bg-gray-200 rounded-lg aspect-video shadow-inner"
          >
          ...
          <div
            class="relative min-h-24 mt-4 p-4 bg-orange-50/80 border border-orange-100 rounded-lg"
...
const flowerGif = "/images/20-11/teachers-day-slideshow/flower.gif";
