<template>
  ...
  >
      ...
      <div class="relative z-20 flex flex-col items-center">
        ...
        >
          <div class="aspect-square overflow-hidden bg-gray-100 relative">
            <img
              :src="drawnImageSrc"
              class="w-full h-full object-cover animate-draw block"
              alt="Memory"
            />
          </div>
    ...
    <div
      v-show="scene === 2"
      class="w-full h-screen flex items-center justify-center bg-scene-2"
      ref="castleContainer"
    >
      <div
        class="relative group cursor-pointer transition-transform active:scale-95"
        @click="goToScene3"
      >
        <div
        ...
        >
          ...
          >
            <div
              class="absolute -top-1 left-4 w-4 h-2 bg-white rounded-sm rotate-12"
            ></div>
            <div
              class="absolute -top-1 right-4 w-3 h-2 bg-white rounded-sm -rotate-6"
            ></div>
          </div>
        </div>
    ...
    >
      <div class="relative w-[92vw] max-w-[480px] animate-fade-in">
        <div
          class="absolute inset-0 bg-white rounded-2xl -rotate-3 shadow-lg scale-[0.98]"
        ></div>
        ...
        >
          ...
          <div
            class="absolute bottom-2 left-2 w-[20vw] max-w-[100px] z-20 pointer-events-none"
          >
            <img
              :src="imgBooksStack"
              alt="Books"
              class="w-full drop-shadow-md transform -rotate-6"
            />
          </div>

          <div
            class="absolute top-4 left-3 w-[15vw] max-w-[70px] z-20 animate-write pointer-events-none"
          >
            <img
              :src="imgFountainPen"
              alt="Pen"
          ...
          <div
            class="relative z-30 flex flex-col items-center w-full pt-8 pb-4 pl-[20vw] md:pl-[100px] pr-4"
          >
            <h2
              class="font-hand letter-title text-2xl md:text-3xl font-bold mb-4 text-center min-h-9"
            >
              {{ letterTitleRef }}
            </h2>

            <div
              class="w-full max-h-[220px] overflow-y-auto custom-scrollbar text-center md:text-left"
            >
              <p
...
const imgThankYou = "/images/20-11/rose-and-letter/giphy.gif";
const imgFlowerFall = "/images/20-11/rose-and-letter/flower.gif";
const imgFlowerV3 = "/images/20-11/rose-and-letter/flower-v3.gif";
const imgFlowerV4 = "/images/20-11/rose-and-letter/flower-v4.gif";
const imgFountainPen = "/images/20-11/rose-and-letter/fountain-pen.png";
const imgBooksStack = "/images/20-11/rose-and-letter/books-stack.png";
