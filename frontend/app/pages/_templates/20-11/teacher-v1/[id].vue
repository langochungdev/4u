...
<template>
    ...
    <div class="min-h-screen w-full flex justify-center bg-[#fce4ec]">
        ...
        <div class="relative w-full max-w-[480px] min-h-screen overflow-hidden text-gray-900 bg-[#faf6ef]">
            ...
            <div class="relative z-10 mx-auto mt-[-110px] md:mt-[-100px] w-[min(92vw,480px)] scale-80 md:scale-95"
                ref="bowRef" style="transform-origin: center top;">
                <!-- giấy bó hoa -->
                <svg viewBox="0 0 440 540" class="w-full h-auto overflow-visible relative z-0"
                    xmlns="http://www.w3.org/2000/svg">
                    <g transform="translate(220,475)" pointer-events="none">
                        <image :href="giayHoaUrl" x="-190" y="-300" width="380" height="420"
                ...
                <!-- Thân + Hoa -->
                <svg viewBox="0 0 440 540" class="w-full h-auto overflow-visible absolute inset-0 z-10"
                    xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g transform="translate(220,475)" pointer-events="none">
                        ...
                        ]" :key="i" :style="{ '--sd': `${s.delay}s`, '--fd': `${s.delay + 2.0}s` }">
                            <path :d="`M 0,0 C ${s.c1},-46 ${s.c2},-125 ${s.dx},${s.topY}`" stroke="url(#stemGrad)"
                                stroke-width="6" stroke-linecap="round" vector-effect="non-scaling-stroke" fill="none"
                                ...
                                <g class="flower-anim--bloom">
                                    <g class="spin-slow">
                                        <g v-for="n in 12" :key="n" :transform="`rotate(${n * 30}) translate(0,-24)`">
                                            <ellipse cx="0" cy="0" rx="9" ry="18" fill="url(#petalGrad)"
                                                stroke="#eab308" stroke-width=".5" opacity=".98" />
                                        </g>
                                    </g>
                ...
                <div v-show="envVisible" class="envpull absolute z-50 env-theme-cream"
                    :class="{ opened: envelopeOpen, 'env--pulse': envReady && !envelopeOpen }" :style="{
                        top: bowY + 'px',
                    ...
                    <div class="envp-wrap">
                        ...
                        <div class="envp-string">
                            <div class="envp-handle" :style="{ transform: `translateX(${pullPx}px) translateY(-85%)` }"
                                @pointerdown="onPullStart" @pointermove="onPullMove" @pointerup="onPullEnd"
                                @pointercancel="onPullEnd" @pointerleave="onPullEnd" title="Kéo sang phải để mở">
                                <span class="dot">⟡</span>
                            </div>
                        </div>
                    </div>
