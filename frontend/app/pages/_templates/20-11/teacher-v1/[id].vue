...
const giayHoaPublicUrl = '/images/20-11/teacher-v1/giay-hoa.png';
const nenPublicUrl = '/images/20-11/teacher-v1/nen.jpg';
  ...
  <div class="min-h-screen w-full flex justify-center bg-[#fce4ec]">
    ...
    >
      ...
      <div
        ...
        :style="{ backgroundImage: `url(${nenPublicUrl})` }"
      ></div>
